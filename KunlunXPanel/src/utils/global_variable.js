...
const role_type_arr = [{ value: 'super_dba_role', label: '超级DBA' }, {
  value: 'ordinary_dba',
  label: '普通DBA'
}, { value: 'ordinary_user', label: '普通用户' }, { value: 'role_user', label: '角色' }]
...
const datatree_arr = [{
  id: 'cluster',
  label: '集群权限',
  children: [{ id: 'cluster_add', label: '新增集群' }, { id: 'cluster_del', label: '删除集群' }, {
    id: 'cluster_backeup',
    label: '备份集群'
  }, { id: 'cluster_restore', label: '恢复集群' }, { id: 'cluster_expand', label: '集群扩容' }, {
    id: 'cluster_shrink',
    label: '集群缩容'
  }, { id: 'backup_service_en', label: '启/禁用备份服务' }, {
    id: 'storage',
    label: '存储节点权限',
    children: [{ id: 'storage_node_create', label: '新增存储节点' }, {
      id: 'storage_node_drop',
      label: '删除存储节点'
    }, { id: 'storage_en', label: '启/禁用存储节点' }]
  }, {
    id: 'comp',
    label: '计算节点权限',
    children: [{ id: 'comp_add', label: '新增计算节点' }, { id: 'comp_del', label: '删除计算节点' }, {
      id: 'comp_en',
      label: '启/禁用计算节点'
    }]
  }, {
    id: 'shard',
    label: '存储shard权限',
    children: [{ id: 'shard_add', label: '新增存储shard' }, { id: 'shard_del', label: '删除存储shard' }]
  }]
}, {
  id: 'equip',
  label: '计算机权限',
  children: [{ id: 'equip_add', label: '新增计算机' }, { id: 'equip_edit', label: '编辑计算机' }, {
    id: 'equip_del',
    label: '删除计算机'
  }]
}]
...
const shards_arr = [{ id: '1', label: '1' }, { id: '2', label: '2' }, { id: '3', label: '3' }, {
  id: '4',
  label: '4'
...
const per_shard_arr = [{ id: '3', label: '3' }, { id: '4', label: '4' }, { id: '5', label: '5' }, {
  id: '6',
  label: '6'
}, { id: '7', label: '7' }, { id: '8', label: '8' }, { id: '9', label: '9' }, { id: '10', label: '10' }]
const node_type_arr = [{ id: 'add_shards', label: 'shard' }, { id: 'add_comps', label: '计算节点' }, {
  id: 'add_nodes',
  label: '存储节点'
}]
