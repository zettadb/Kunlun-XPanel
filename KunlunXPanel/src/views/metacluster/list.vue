  ...
  <div class="app-container">
    <div class="filter-container">
      <div class="table-list-search-wrap">
        <el-input class="list_search_keyword" v-model="listQuery.hostaddr" placeholder="可输入IP搜索"
        ...
        >添加节点</el-button> -->
        <el-button class="filter-item" type="primary" @click="handleSwitch" v-if="meta_ha_mode === 'rbr'"><i
            class="el-icon-sort" style="transform:rotate(90deg);"></i>主备切换</el-button>
        <el-button class="filter-item" type="primary" icon="el-icon-copy-document" @click="handleRedo"
          v-if="meta_ha_mode === 'rbr'">重做备机</el-button>
    ...
    <el-table :key="tableKey" v-loading="listLoading" :data="list" border highlight-current-row
      ...
      <el-table-column align="center" label="高可用模式">
        <template>
      ...
      <el-table-column prop="replica_delay" align="center" label="主备延迟时间(s)">
      </el-table-column>
      <!-- <el-table-column
        label="操作"
        align="center"
