    ...
    <div class="page2">
        <Row class='content'>
            <Col span="8">
                <div class="list">
                    <div class="left">
                        ...
                        <div class="chart-68">
                            <clusterStatus ref="chart1"></clusterStatus>
            ...
            <Col span="8">
                ...
                <div class="list" style="margin-top:200px;">
                    <div class="right">
                        <span class='title'><span class="title-8">设备在/离线统计</span></span>
                        <span class="angle1"></span>
                        <span class="angle2"></span>
                        <span class="angle3"></span>
                        <span class="angle4"></span>
                        ...
                        <div class="chart-68">
                            <equipStatus ref="chart8"></equipStatus>
...
<script>
//import equipStatus from '../components/page2/equipStatus.vue';
...
const equipStatus = () => import('../components/page2/equipStatus');
const clusterStatus = () => import('../components/page2/clusterStatus');
export default {
    name: 'page2',
