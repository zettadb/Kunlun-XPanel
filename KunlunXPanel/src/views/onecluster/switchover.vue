    ...
    >
      ...
      >
        ...
        >
          ...
          <el-table-column prop="shard_id" align="center" label="shard_id" />
          ...
          <el-table-column prop="step" align="center" label="step" />
          <el-table-column prop="new_master_host" align="center" label="new_master_host" />
          <!-- <el-table-column prop="description" align="center" label="description"></el-table-column> -->
          <el-table-column
            prop="consfailover_msg"
            align="center"
            label="consfailover_msg"
            :show-overflow-tooltip="true"
          />
          <el-table-column prop="timestamp" align="center" label="timestamp" />
          <!-- <el-table-column prop="err_code" align="center" label="err_code"></el-table-column> -->
          <el-table-column prop="err_msg" align="center" label="err_msg" />
        </el-table>
      </el-form>
