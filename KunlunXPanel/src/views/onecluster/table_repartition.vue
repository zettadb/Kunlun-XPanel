...
<script>
import { tableRepartition, getPGTableList, getEvStatus, clusterOptions } from '@/api/cluster/list'
      ...
      this.$refs['form'].validate((valid) => {
        if (valid) {
          ...
          const repartition_tables = this.form.repartition_tables.map(v => {
            return v.srcTable[0] + '_$$_public.' + v.srcTable[1] + '=>' + v.ditTable[0] + '_$$_public.' + v.ditTable[1]
          }).join(',')
