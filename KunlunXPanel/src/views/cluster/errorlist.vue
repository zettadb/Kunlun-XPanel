  ...
  <div class="app-container">
    ...
    >
      ...
      >
        ...
        <el-form-item v-show="dialogStatus==='create'||'detail'" label="副本数:" prop="snode_count">
          <el-input
        ...
        <div v-show="isShow" v-if="dialogStatus==='create'?true:false">
          ...
          <el-form-item label="每个存储节点innodb缓冲池大小:" prop="per_storage_node_innodb_buffer_pool_size">
            <el-input
              v-model="temp.per_storage_node_innodb_buffer_pool_size"
              class="right_input"
              placeholder="请输入每个存储节点innodb缓冲池大小"
            >
              <i slot="suffix" style="font-style:normal;margin-right: 10px; line-height: 30px;">MB</i>
            </el-input>
          </el-form-item>
      ...
      >
        <el-form-item v-if="dialogStatus==='restore'" label="选择计算机:" prop="machinelist">
          <el-checkbox-group
            ...
            :max="machineTotal"
          >
            <el-checkbox v-for="machine in machines" :key="machine.id" :label="machine.hostaddr">
              {{ machine.hostaddr }}
            </el-checkbox>
          </el-checkbox-group>
        </el-form-item>
