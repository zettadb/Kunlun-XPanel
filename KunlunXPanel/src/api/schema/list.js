...
export function addSchmea(data) {
  return request({
    url: '/user/Cluster/AddSchema',
    method: 'post',
    data
  })
}

export function deleteSchmea(data) {
  return request({
    url: '/user/Cluster/DeleteSchema',
    method: 'post',
    data
  })
}
...
export function createSchemaRole(data) {
  return request({
    url: '/user/Cluster/CreateSchemaRole',
    method: 'post',
    data
  })
}
