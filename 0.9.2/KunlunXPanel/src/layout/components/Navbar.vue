<template>
  <div class="navbar">
    ...
    <div class="right-menu">
      <a class="right-menu-item" @click="showDocument" title="查看功能简介"><i class="el-icon-question"></i></a>
      <span class="right-menu-item" v-if="!login_auth">|</span>
      <a class="right-menu-item" @click="showMachine" title="查看机器监控信息"><i class="el-icon-monitor"></i></a>
      <span class="right-menu-item" v-if="!login_auth">|</span>
